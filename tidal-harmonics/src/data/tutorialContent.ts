  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        content: "Tide gauges record everything together: the 12.5-hour tidal rhythm, the fortnightly Mf, the annual Sa. To detect true sea level rise — a few millimeters per year — scientists must remove these known harmonics first. Without this tidal separation, a single cold winter could look like climate recovery. Harmonic decomposition isn't just elegant math — it's essential for understanding our changing planet.",
        duration: 9,
        ...
        emphasizedConstituent: 'Sa',
        showOrbits: true,
        timeSpeed: 604800, // 1 week/sec - see long-period variations
      },
    ],
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        id: 'ch10-go',
        title: 'Explore!',
        content: "The phasors spin at their eternal frequencies: M2 at 12.42 hours, S2 at 12.00, their interference creating spring and neap every 14.77 days. Toggle any constituent — watch it vanish from the prediction. Change stations — see how geography reshapes the ratios. You've decoded 300 years of tidal science. The ocean's rhythm was always there, waiting to be read.",
        duration: 0,
